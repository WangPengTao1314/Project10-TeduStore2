...
<div class="lf1">
    ...
    <div class="lf1_bottom">
           ...
           <div class="item_cat_all" >
                ...
                <ul>
                  <c:forEach items="${category161List[abc.index]}" var="computer">
                    <li><a href="${pageContext.request.contextPath}/showSearch.do?categoryId=${computer.id}">${computer.name}</a></li>
                   </c:forEach>
                </ul>
                 </c:forEach>
            </div>
        ...
        <div class="item_msg lf">
            <img style="width: 198px;height: 136px" src="${pageContext.request.contextPath}${goods.image}" alt=""/>

            <p class="bottom_ys2">${goods.title}</p>

            <p class="bottom_ys3">￥${goods.price}</p>

            <p class="bottom_ys4 color_2"><a href="${pageContext.request.contextPath}/goodsInfo.do?goodsId=${goods.goodsId}&categoryId=${goods.categoryId}">查看详情</a></p>
        </div>
       </c:forEach>

...
<body>
	<div class="big" style="min-height: 740px;">
		<form name="" action="" method="post">
    	    ...
    	    <c:forEach items="${goodsList}" var="goods">
					<div class="lf" id="d1">
						<div class="img">
							<img src="${pageContext.request.contextPath}${goods.image}" alt="" onclick="toItemInfo(${goods.goodsId},${goods.categoryId})" />
						</div>			
						<div class="describe">
                          <!--超出的范围隐藏  -->
							<p onclick="toItemInfo(${goods.goodsId},${goods.categoryId})"style="width:230px;height:14px; overflow:hidden;">${goods.title}</p>
							<span class="price"><b>￥</b><span class="priceContent"></span>${goods.price}</span>
 ...
 <!-- 当前页下标样式设置 -->
  <a href="${pageContext.request.contextPath}/showSearch.do?categoryId=${categoryId}&page=${i}"
...
<div class="modal" style="display:none">
 ...
 <script type="text/javascript">
	...
	function toItemInfo(goodsId,categoryId) {
		if (goodsId) {
			window.location.href="${pageContext.request.contextPath}/goodsInfo.do?goodsId="+goodsId+"&categoryId="+categoryId;
		}else {
			alert("商品id不存在");
		}
	} 

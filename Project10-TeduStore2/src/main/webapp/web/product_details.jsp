...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="${pageContext.request.contextPath}/images/product_detail/product_detail_img15.png"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
...
<script type="text/javascript">
    ...
    $("#add_cart").click(function (e) {
        	$.ajax({
        		...
        		"data":"goodsId="+$("#goodsId").val()+"&count="+$("#buy-num").val(),
        		"type":"GET",
        		"dataType":"JSON",
        		"success":function(obj){
        			...
        			/* 
        			当发送异步请求时,如果响应的是重定向页面,
        			不会执行success
        			使用error属性从新发送请求
        			*/
        		    "error":function(){
        		    	location="${pageContext.request.contextPath}/toLogin.do";

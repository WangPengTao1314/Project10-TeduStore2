...
<div id="container">
    <div id="cover" class="rt">
        <form id="login-form" method="post" name="form1">
            <div class="txt">
                <p>
					登录学子商城<span><a href="${pageContext.request.contextPath}/showRegister.do">新用户注册</a></span>
                </p>
                <div class="text">
                    <input type="text" placeholder="请输入您的用户名" 
                    name="lname" id="username" required>
                    <span id="userSpan"><img src="${pageContext.request.contextPath}/images/login/yhm.png"></span>
                </div>
                
                <div class="text">
                    <input type="password" id="password" placeholder="请输入您的密码" name="lwd" required minlength="6" maxlength="15">
                    <span id="pwdSpan"><img src="${pageContext.request.contextPath}/images/login/mm.png"></span>
                </div>
                <div class="chose">
    ...
    // var inputData = $('#login-form').serialize();
		...
		$.ajax({
            ...
            "data":$("#login-form").serialize(),
         		//"data":"username="+$("#lname").val()+"&password="+$("lwd").val(),
            "dataType":"json",

                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="pudcId3">
                            <img src="${pageContext.request.contextPath}${cartList.image}" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                           ${cartList.title}
                              <input type="hidden" name="" value="">
                    ...
                    <div class="pices">
                        ...
                        <p class="pices_information"><b>￥</b><span>${cartList.price}<input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="${cartList.count}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cartList.price*cartList.count}</span>
                    </div>
                    <div class="del">
                        <!-- <div>

...
public class Goods implements Serializable{
	...
	public String toString() {
		return "Goods [goodsId=" + goodsId + ", categoryId=" + categoryId + ", itemType=" + itemType + ", title="
				+ title + ", sellPoint=" + sellPoint + ", price=" + price + ", num=" + num + ", barcode=" + barcode
				+ ", image=" + image + ", status=" + status + ", priority=" + priority + ", createdUser=" + createdUser
